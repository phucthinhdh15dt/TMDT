...
//                optionsBuilder.UseSqlServer("Server=PHUCTHINH\\SQL;Database=ChoThueXe;User Id=sa;Password=1;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.Id, e.IdCar, e.IdFeature });
            ...
            {
                entity.HasKey(e => new { e.Id, e.IdPackage, e.IdFeaturePackage });
            ...
            {
                entity.HasKey(e => new { e.Id, e.IsCar, e.StatusHire });
            ...
            {
                entity.HasKey(e => new { e.Id, e.IdPackage, e.IdPartner });
